...
public enum MovieApiRoute: ApiRoute {
    ...
    case moviesByYear(Int, query: String, page: Int, env: MovieApiEnvironment)
    ...
    public var queryParams: [String : String] {
        ...
        case .moviesByYear(let year, let query, let page, let env): return ["y": "\(year)", "s": query, "type": "movie", "page": "\(page)", "apikey": env.apiKey]
        }
    }
}
